"""
Train ridge regression from fMRI to CLIP image embeddings.

Fits a ridge regression model mapping image-level fMRI betas to CLIP image
embeddings with validation-based alpha selection.

Usage:
    python train_ridge_fmri_to_clip_image.py
"""
...
def main():
    """
    Train ridge regression mapping averaged fMRI betas to CLIP image embeddings.
